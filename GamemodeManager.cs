    ...
    public class SlimeGamemodesManager
    {
        ...
        public void PublishState()
        {
            ...
            MenuUI.gameObject.SetActive(false);
                ...
                void OnClickedPopUpPrank(bool Clicked)
                {
                    if (Clicked)
            ...
            Il2CppSystem.Action<bool> ActionOnClick = new System.Action<bool>(OnClickedPopUpPrank);


                LevelEditorManagerUI.ShowGenericPopup("wle_creativeexpansion_stop", "wle_creativeexpansion_stop_description", "wle_creative_expansion_stop_confirm", LevelEditorManager.Instance.UI._errorSprite, UIModalMessage.OKButtonType.Positive, ActionOnClick, UIModalMessage.ModalType.MT_OK_CANCEL, PopupInteractionType.Warning);
        ...
        public void InitializeRisingSlimeMode(out GameModeData RisingSlimeGamemode)
        {
            ...
            GameModeSlime._completionCriteria = new Il2CppStructArray<LevelEditorOptionsSingleton.Criteria>(2);
        ...
        IEnumerator IntializeGamemodesEnumerator()
        {
